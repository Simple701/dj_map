    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                var uid= editor.getOpt('LoginUid');
                ...
                var now = new Date();
                var filename = 'u'+uid+'_'+Date.parse(now)+randNumber+"."+file.file.ext;
                data['key'] = filename;
        ...
        getInsertList: function () {
            var i, data, list = [],
                align = getAlign(),
                prefix = 'http://oaqpu3kp9.bkt.clouddn.com/';
    ...
    SearchImage.prototype = {
        ...
        getImageData: function(){
            var _this = this,
                ...
                url = "http://image.baidu.com/i?tn=baiduimagejson&istype=2&rn=32&fm=index&pv=&word=" + key + type + "&ie=utf8&oe=utf8&keeporiginname=" + keepOriginName + "&" + +new Date;
